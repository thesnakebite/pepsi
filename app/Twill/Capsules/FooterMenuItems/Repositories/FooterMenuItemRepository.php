...
namespace App\Twill\Capsules\FooterMenuItems\Repositories;

use A17\Twill\Repositories\Behaviors\HandleNesting;
use A17\Twill\Repositories\ModuleRepository;
use App\Twill\Capsules\FooterMenuItems\Models\FooterMenuItem;

class FooterMenuItemRepository extends ModuleRepository
{
    use HandleNesting;
    ...
    public function __construct(FooterMenuItem $model)
    {
        $this->model = $model;
    }
