...
namespace App\Twill\Capsules\FooterMenuItems\Http\Controllers;

use A17\Twill\Http\Controllers\Admin\NestedModuleController as BaseModuleController;

class FooterMenuItemController extends BaseModuleController
{
    protected $moduleName = 'footerMenuItems';
